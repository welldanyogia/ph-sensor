...
<div class="container" style="text-align: center; margin-top:100px">
    <h2>
        Monitoring Multi Sensor ESP32<br> Secara Realtime
    </h2>
    <div style="display: flex;">
        ...
        <div class="card text-center" style="width: 33.33%">
            ...
            <div class="card-body">
                <h1><span id="cekvoltage">{{ $voltage ?? 0 }}</span></h1>
            </div>
        </div>
        ...
        <div class="card text-center" style="width: 33.33%">
            ...
            <div class="card-body">
                <h1><span id="ceksifat">{{ $sifat ?? 0 }}</span></h1>
            </div>
        </div>
    </div>
...
<script>
    $(document).ready(function () {
        // Fungsi untuk memperbarui data secara otomatis setiap 5 detik
        function updateData() {
            $.ajax({
                url: '/latest-data',
                method: 'GET',
                success: function (data) {
                    ...
                    $('#cekph').text(data.ph);
                    $('#cekvoltage').text(data.voltage);
                    $('#ceksifat').text(data.sifat);
                },
        ...
        // Jalankan fungsi updateData setiap 5 detik
